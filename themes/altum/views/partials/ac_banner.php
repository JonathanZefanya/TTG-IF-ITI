...
<style>
    ...
    .ac-altumcode-link:hover .ac-zyrex-image {
        transform: scale(1.15);
    }

    .ac-altumcode-link:active .ac-zyrex-image {
        transform: scale(.9);
    }
...
<div class="ac-wrapper">
    <a href="https://zyrex.win/" target="_blank" class="ac-altumcode-link">
        <img src="https://zyrex.win/asset-user/images/Logo_Zyrex_29032025181450.png" alt="Zyrex logo" class="ac-zyrex-image" />
        <span><?= $data->product_name . ' by <span class="ac-altumcode-link-brand">Zyrex</span>' ?></span>
    </a>

    <div class="ac-cta-wrapper">
        <a href="https://zyrex.win/contact" target="_blank" class="ac-secondary"><span class="d-none d-lg-inline">Any questions? ✉️</span><span class="d-lg-none">Support</span></a>
