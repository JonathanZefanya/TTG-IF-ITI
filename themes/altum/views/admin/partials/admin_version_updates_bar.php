...
<?php if(
    ...
    <div class="alert alert-success mb-4">
        ...
        <div class="mb-3">
            <span>You can now download it and update as per the <a href="<?= PRODUCT_DOCUMENTATION_URL ?>" target="_blank">documentation</a> of the product, or <a href="https://zyrex.win/contact" target="_blank">hire me (altumcode)</a> to update it for you.</span>
        </div>
