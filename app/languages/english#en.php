...
return [
    ...
    'global.emails.user_data_collected_phone_collector.body' => 'Hey there <strong>{{NAME}}</strong>,<br /><br />You just got a new <strong>Phone Collector</strong> data submission from one of your visitors.<br /><br /><strong>Phone:</strong> {{DATA_PHONE}}<br /><strong>Name:</strong> {{DATA_NAME}}<br /><br /><a href="{{DATA_LINK}}">View all collected data</a><br /><br />Greetings from {{WEBSITE_TITLE}}.',
    'global.emails.user_data_collected_email_collector.body' => 'Hey there <strong>{{NAME}}</strong>,<br /><br />You just got a new <strong>Email Collector</strong> data submission from one of your visitors.<br /><br /><strong>Email:</strong> {{DATA_EMAIL}}<br /><strong>Name:</strong> {{DATA_NAME}}<br /><br /><a href="{{DATA_LINK}}">View all collected data</a><br /><br />Greetings from {{WEBSITE_TITLE}}.',
    'global.emails.user_data_collected_contact_collector.body' => 'Hey there <strong>{{NAME}}</strong>,<br /><br />You just got a new <strong>Contact Form</strong> data submission from one of your visitors.<br /><br /><strong>Email:</strong> {{DATA_EMAIL}}<br /><strong>Phone:</strong> {{DATA_PHONE}}<br /><strong>Name:</strong> {{DATA_NAME}}<br /><strong>Message:</strong> {{DATA_MESSAGE}}<br /><br /><a href="{{DATA_LINK}}">View all collected data</a><br /><br />Greetings from {{WEBSITE_TITLE}}.',
    ...
    'global.plan_settings.documents_model.gpt_4o' => 'Ultimate AI model',
    'global.plan_settings.documents_model.gpt_4o_mini' => 'Fasg & Great AI model',
    ...
    'global.plan_settings.transcriptions_file_size_limit' => '<strong>%s</strong> audio files transcriptions',
    'global.plan_settings.chats_per_month_limit' => '<strong>%s</strong> AI chats / month',
    'global.plan_settings.chat_messages_per_chat_limit' => '<strong>%s</strong> AI chats messages / chat',
    ...
    'index.developer.header' => 'Let\'s See Developer',
    'index.developer.one.text' => 'Perfect code might just be an illusion, but every line you write is a step closer to innovation.',
    'index.developer.one.name' => 'Jonathan Zefanya',
    'index.developer.one.attribute' => 'Owner Web-Tools',
    'index.developer.two.text' => 'Every error is not an obstacle, but an opportunity to learn and grow.',
    'index.developer.two.name' => 'Nahida',
    'index.developer.two.attribute' => 'Lesser Lord Kusanali',
    'index.developer.three.text' => 'A great website is not just about design or code; it\'s about how you bring ideas and solutions into the digital world.',
    'index.developer.three.name' => 'Tribbie',
    'index.developer.three.attribute' => 'Holy Maidens of Janusopolis',
    ...
    'api_documentation.splash_pages' => 'Splash pages',
    'api_documentation.qr_codes' => 'QR codes',
    'api_documentation.signatures' => 'Signatures',
    'api_documentation.data' => 'Data',
    ...
    'splash_pages.input.logo' => 'Logo',
    'splash_pages.input.favicon' => 'Favicon',
    'splash_pages.input.opengraph' => 'Opengraph image',
    'splash_pages.input.title' => 'Title',
    'splash_pages.input.secondary_button_name' => 'Secondary button name',
    'splash_pages.input.secondary_button_url' => 'Secondary button URL',
    'splash_pages.input.link_unlock_seconds' => 'Countdown timer',
    'splash_pages.input.link_unlock_seconds_help' => 'How much it takes for the final link to unlock.',
    'splash_pages.input.auto_redirect' => 'Auto redirect',
    'splash_pages.input.auto_redirect_help' => 'Auto redirect to final link after the countdown timer ends.',
    'splash_pages.input.ads_header' => 'Ads header',
    'splash_pages.input.ads_footer' => 'Ads footer',
    ...
    'qr_codes.input.vcard_phone_number_label_help' => 'Leave empty to use the default phone generated label.',
    ...
    'link.biolink.blocks.snapchat' => 'Snapchat Spotlight/Lens',
    ...
    'create_event_modal.input.event_start_datetime' => 'Event starts on',
    'create_event_modal.input.event_end_datetime' => 'Event ends on',
    'create_event_modal.input.event_first_alert_datetime' => 'First alert reminder',
    'create_event_modal.input.event_second_alert_datetime' => 'Second alert reminder',
    ...
    'create_static_modal.input.file' => 'HTML or ZIP file',
    'create_static_modal.input.file.inside_zip_whitelisted_file_extensions' => 'File types allowed inside of a ZIP file: %s',
    'create_static_modal.input.file.help1' => 'Make sure your zip file contents have an <code>index.html</code> file when unzipped.',
    'create_static_modal.input.file.help2' => 'Make sure your you reference your images, js, css...etc in the following relative format, example: <code>&lt;link rel="stylesheet" href="./css/styles.css"&gt;</code>.',
    'create_static_modal.input.submit' => 'Create static site',
    ...
    'create_biolink_link_modal.subheader' => 'Link to any external web pages with ease.',
    ...
    'create_biolink_link_modal.input.description_color' => 'Description color',
    ...
    'create_biolink_link_modal.input.border_shadow_color' => 'Border shadow color',
    'create_biolink_link_modal.input.border_shadow_offset_x' => 'Border shadow offset X',
    'create_biolink_link_modal.input.border_shadow_offset_y' => 'Border shadow offset Y',
    'create_biolink_link_modal.input.border_shadow_blur' => 'Border shadow blur',
    'create_biolink_link_modal.input.border_shadow_spread' => 'Border shadow spread',
    ...
    'create_biolink_link_modal.input.object_fit' => 'Fit',
    ...
    'create_biolink_link_modal.border_header' => 'Border settings',
    'create_biolink_link_modal.border_shadow_header' => 'Border shadow settings',
    ...
    'create_biolink_link_modal.input.display_browsers' => 'Browsers',
    'create_biolink_link_modal.input.display_cities_placeholder' => 'Tokyo, New York, Istanbul',
    'create_biolink_link_modal.input.display_cities_help' => 'Comma separated values. Leave empty for all.',
    'create_biolink_link_modal.settings.display_help' => 'Select who should see this block. Leave empty for all.',



    'create_biolink_heading_modal.header' => 'Add a heading',
    'create_biolink_heading_modal.subheader' => 'A heading section will allow you to separate your page content.',
    'create_biolink_heading_modal.heading_type' => 'Type',


    'create_biolink_paragraph_modal.header' => 'Add a paragraph',
    'create_biolink_paragraph_modal.subheader' => 'A block of simple text.',


    'create_biolink_markdown_modal.header' => 'Add a markdown block',
    'create_biolink_markdown_modal.subheader' => 'A block of parsed markdown formatted text.',


    'create_biolink_avatar_modal.header' => 'Add an avatar',
    'create_biolink_avatar_modal.subheader' => 'An image with different styles to act like your page avatar.',
    ...
    'create_biolink_socials_modal.subheader' => 'A collection of social media links with their respective icons.',
    ...
    'create_biolink_socials_modal.socials.vk.name' => 'VK',
    'create_biolink_socials_modal.socials.vk.placeholder' => 'id',
    ...
    'create_biolink_socials_modal.socials.whatsapp.placeholder' => '2124567890',
    'create_biolink_socials_modal.socials.whatsapp_channel.name' => 'Whatsapp channel',
    'create_biolink_socials_modal.socials.whatsapp_channel.placeholder' => '00123abcd456jkl123',
    ...
    'create_biolink_socials_modal.socials.threads.name' => 'Threads',
    'create_biolink_socials_modal.socials.threads.placeholder' => 'Threads username',
    'create_biolink_socials_modal.socials.reddit.name' => 'Reddit',
    'create_biolink_socials_modal.socials.reddit.placeholder' => 'Reddit page / username',
    'create_biolink_socials_modal.socials.rumble.name' => 'Rumble',
    'create_biolink_socials_modal.socials.rumble.placeholder' => 'Rumble channel / video',
    'create_biolink_socials_modal.socials.signal.name' => 'Signal',
    'create_biolink_socials_modal.socials.signal.placeholder' => 'Signal link',

    'create_biolink_image_modal.header' => 'Add an image',
    'create_biolink_image_modal.subheader' => 'A simple & good looking image block for your page.',


    'create_biolink_youtube_modal.header' => 'Add a YouTube video',
    'create_biolink_youtube_modal.subheader' => 'Display a YouTube video on your page with ease.',
    ...
    'create_biolink_youtube_modal.video_autoplay' => 'Allow video autoplay',
    'create_biolink_youtube_modal.video_controls' => 'Display video controls',
    'create_biolink_youtube_modal.video_loop' => 'Video loop enabled',
    'create_biolink_youtube_modal.video_muted' => 'Video is muted',


    'create_biolink_twitch_modal.header' => 'Add a Twitch video',
    'create_biolink_twitch_modal.subheader' => 'Display a Twitch account widget on your page with ease.',
    'create_biolink_twitch_modal.location_url' => 'Twitch URL',
    'create_biolink_twitch_modal.location_url_placeholder' => 'https://www.twitch.tv/sodapoppin',


    'create_biolink_vimeo_modal.header' => 'Add a Vimeo video',
    'create_biolink_vimeo_modal.subheader' => 'Display a Vimeo video on your page with ease..',
    ...
    'create_biolink_soundcloud_modal.subheader' => 'Display a Soundcloud player widget on your page with ease.',
    ...
    'create_biolink_threads_modal.header' => 'Add a Threads post',
    'create_biolink_threads_modal.subheader' => 'Display a Threads post widget on your page with ease.',
    'create_biolink_threads_modal.location_url' => 'Threads Post URL',
    'create_biolink_threads_modal.location_url_placeholder' => 'https://www.threads.net/@zuck/post/Cy3m1VnRiwP',


    'create_biolink_snapchat_modal.header' => 'Add a Snapchat embed',
    'create_biolink_snapchat_modal.subheader' => 'Display a Spotlight video or Lens widget from Snapchat on your page with ease.',
    'create_biolink_snapchat_modal.location_url' => 'Snapchat Spotlight/Lens URL',
    'create_biolink_snapchat_modal.location_url_placeholder' => 'https://www.snapchat.com/spotlight/W7_EDlXWTBiXAEEniNoMPwAAYbnh4Z3d0aHdoAYpqrMorAYpqrKT5AAAAAQ',


    'create_biolink_applemusic_modal.header' => 'Add an Apple Music song',
    'create_biolink_applemusic_modal.subheader' => 'Display an Apple Music player widget on your page with ease.',
    ...
    'create_biolink_tidal_modal.subheader' => 'Display a Tidal player widget on your page with ease.',
    ...
    'create_biolink_anchor_modal.subheader' => 'Display an Anchor FM podcast player widget on your page with ease.',
    ...
    'create_biolink_twitter_profile_modal.header' => 'Add a Twitter profile',
    'create_biolink_twitter_profile_modal.subheader' => 'Display a Twitter profile widget on your page with ease.',
    'create_biolink_twitter_profile_modal.location_url' => 'Twitter Profile URL',
    'create_biolink_twitter_profile_modal.location_url_placeholder' => 'https://twitter.com/naval/',
    'create_biolink_twitter_profile_modal.theme' => 'Theme',


    'create_biolink_twitter_video_modal.header' => 'Add a Twitter video',
    'create_biolink_twitter_video_modal.subheader' => 'Display a Twitter video widget on your page with ease.',
    'create_biolink_twitter_video_modal.location_url' => 'Twitter Video URL',
    'create_biolink_twitter_video_modal.location_url_placeholder' => 'https://x.com/MrBeast/status/1776732112013463825',


    'create_biolink_twitter_tweet_modal.header' => 'Add a Twitter tweet',
    'create_biolink_twitter_tweet_modal.subheader' => 'Display a Twitter tweet widget on your page with ease.',
    ...
    'create_biolink_pinterest_profile_modal.header' => 'Add a Pinterest profile',
    'create_biolink_pinterest_profile_modal.subheader' => 'Display a Pinterest profile widget on your page with ease.',
    'create_biolink_pinterest_profile_modal.location_url' => 'Pinterest Profile URL',
    'create_biolink_pinterest_profile_modal.location_url_placeholder' => 'https://pinterest.com/Google/',


    'create_biolink_instagram_media_modal.header' => 'Add Instagram media',
    'create_biolink_instagram_media_modal.subheader' => 'Display an Instagram post, video or reel widget on your page with ease.',
    ...
    'create_biolink_spotify_modal.header' => 'Add Spotify media',
    'create_biolink_spotify_modal.subheader' => 'Display a Spotify song, album, show or episode widget on your page with ease.',
    ...
    'create_biolink_tiktok_video_modal.header' => 'Add a TikTok video',
    'create_biolink_tiktok_video_modal.subheader' => 'Display a TikTok video widget on your page with ease.',
    'create_biolink_tiktok_video_modal.location_url' => 'TikTok Video URL',
    'create_biolink_tiktok_video_modal.location_url_placeholder' => 'https://www.tiktok.com/@charlidamelio/video/6808693617306111237',


    'create_biolink_tiktok_profile_modal.header' => 'Add a TikTok profile',
    'create_biolink_tiktok_profile_modal.subheader' => 'Display a TikTok profile widget on your page with ease.',
    'create_biolink_tiktok_profile_modal.location_url' => 'TikTok Profile URL',
    'create_biolink_tiktok_profile_modal.location_url_placeholder' => 'https://www.tiktok.com/@charlidamelio',


    'create_biolink_vk_video_modal.header' => 'Add a VK video',
    'create_biolink_vk_video_modal.subheader' => 'Display a VK video widget on your page with ease.',
    'create_biolink_vk_video_modal.location_url' => 'VK Video URL',
    'create_biolink_vk_video_modal.location_url_placeholder' => 'https://vk.com/video-30666517_456244845',


    'create_biolink_email_collector_modal.header' => 'Add a sign up form',
    'create_biolink_email_collector_modal.subheader' => 'Easily capture emails from your visitors.',
    'create_biolink_email_collector_modal.email_collector_header' => 'Form settings',
    'create_biolink_email_collector_modal.email_placeholder' => 'Email placeholder',
    'create_biolink_email_collector_modal.name_placeholder' => 'Name placeholder',
    'create_biolink_email_collector_modal.button_text' => 'Button text',
    'create_biolink_email_collector_modal.success_text' => 'Thank you message',
    'create_biolink_email_collector_modal.show_agreement' => 'Show agreement checkbox',
    'create_biolink_email_collector_modal.show_agreement_help' => 'Require the user to confirm his agreement by ticking a checkbox.',
    'create_biolink_email_collector_modal.agreement_url' => 'Agreement URL',
    'create_biolink_email_collector_modal.agreement_text' => 'Agreement text',
    'create_biolink_email_collector_modal.thank_you_url' => 'Thank you URL',
    'create_biolink_email_collector_modal.thank_you_url_help' => 'Redirect the user to a specific URL after submitting the form. Leave empty to disable.',
    'create_biolink_email_collector_modal.mailchimp_api' => 'Mailchimp API Key',
    'create_biolink_email_collector_modal.mailchimp_api_help' => 'Leave empty to disable mailchimp integration. How to get these details: <a href="https://mailchimp.com/developer/guides/manage-subscribers-with-the-mailchimp-api/#Before_you_start" target="_blank">MailChimp Documentation</a>',
    'create_biolink_email_collector_modal.mailchimp_api_list' => 'Mailchimp List',
    'create_biolink_email_collector_modal.mailchimp_api_list_help' => '',
    'create_biolink_email_collector_modal.email_placeholder_default' => 'hello@example.com',
    'create_biolink_email_collector_modal.name_placeholder_default' => 'Your full name',
    'create_biolink_email_collector_modal.button_text_default' => 'Sign up',
    'create_biolink_email_collector_modal.success_text_default' => 'Thank you for signing up.',
    ...
    'create_biolink_custom_html_modal.subheader' => 'Display any type of custom HTML on your page.',
    'create_biolink_custom_html_modal.html' => 'Custom HTML',


    'create_biolink_vcard_modal.header' => 'Add VCard',
    'create_biolink_vcard_modal.subheader' => 'Your downloadable contact details via a button to your profile.',
    ...
    'create_biolink_vcard_modal.vcard_phone_number_value' => 'Phone number',
    'create_biolink_vcard_modal.vcard_phone_number_label' => 'Label',
    'create_biolink_vcard_modal.vcard_phone_number_label_help' => 'Leave empty to use the default phone generated label.',
    ...
    'create_biolink_image_grid_modal.subheader' => 'Display multiple images on the same row.',
    'create_biolink_image_grid_modal.columns' => 'Columns',


    'create_biolink_list_modal.header' => 'Add a text list',
    'create_biolink_list_modal.subheader' => 'Display an ordered or unordered list on your page.',
    ...
    'create_biolink_alert_modal.subheader' => 'Display an alert notification type of widget with ease.',
    ...
    'create_biolink_divider_modal.subheader' => 'Separate your content with the help of this block.',
    'create_biolink_divider_modal.margin_top' => 'Margin top',
    'create_biolink_divider_modal.margin_bottom' => 'Margin bottom',


    'create_biolink_big_link_modal.header' => 'Add a big link button',
    'create_biolink_big_link_modal.subheader' => 'Link to any external web pages with an expanded link.',
    'create_biolink_big_link_modal.description' => 'Description',
    'create_biolink_big_link_modal.description_color' => 'Description color',


    'create_biolink_faq_modal.header' => 'Add an FAQ block',
    'create_biolink_faq_modal.subheader' => 'Display a block of the most frequent questions & answers for your visitors.',
    'create_biolink_faq_modal.title' => 'Title',
    'create_biolink_faq_modal.content' => 'Content',


    'create_biolink_discord_modal.header' => 'Add a Discord server',
    'create_biolink_discord_modal.subheader' => 'Display a Discord server widget on your page with ease.',
    'create_biolink_discord_modal.server_id' => 'Server Id',


    'create_biolink_facebook_modal.header' => 'Add a Facebook post',
    'create_biolink_facebook_modal.subheader' => 'Display a Facebook post widget on your page with ease.',
    'create_biolink_facebook_modal.location_url' => 'Facebook Post/Video URL',


    'create_biolink_reddit_modal.header' => 'Add a Reddit post',
    'create_biolink_reddit_modal.subheader' => 'Display a Reddit post widget on your page with ease.',
    'create_biolink_reddit_modal.location_url' => 'Reddit Post URL',


    'create_biolink_audio_modal.header' => 'Add an audio file',
    'create_biolink_audio_modal.subheader' => 'Display a playable audio widget on your page with ease.',
    'create_biolink_audio_modal.file' => 'Audio file',
    'create_biolink_audio_modal.audio_autoplay' => 'Allow audio autoplay',
    'create_biolink_audio_modal.audio_controls' => 'Display audio controls',
    'create_biolink_audio_modal.audio_loop' => 'Audio loop enabled',
    'create_biolink_audio_modal.audio_muted' => 'Audio is muted',

    'create_biolink_video_modal.header' => 'Add a video file',
    'create_biolink_video_modal.subheader' => 'Display a playable video widget on your page with ease.',
    'create_biolink_video_modal.file' => 'Video file',
    'create_biolink_video_modal.poster_url' => 'Thumbnail image URL',
    'create_biolink_video_modal.video_autoplay' => 'Allow video autoplay',
    'create_biolink_video_modal.video_controls' => 'Display video controls',
    'create_biolink_video_modal.video_loop' => 'Video loop enabled',
    'create_biolink_video_modal.video_muted' => 'Video is muted',


    'create_biolink_file_modal.header' => 'Add a file block',
    'create_biolink_file_modal.subheader' => 'A link to a downloadable file on your page with ease.',
    'create_biolink_file_modal.file' => 'File',


    'create_biolink_pdf_document_modal.header' => 'Add a PDF document',
    'create_biolink_pdf_document_modal.subheader' => 'A button with a modal opening a PDF viewer & link to the PDF document.',
    'create_biolink_pdf_document_modal.file' => 'File',


    'create_biolink_countdown_modal.header' => 'Add a countdown timer',
    'create_biolink_countdown_modal.subheader' => 'Display a simple countdown widget on your page with ease.',
    ...
    'create_biolink_cta_modal.subheader' => 'A link to a custom action, such as email or phone number.',
    ...
    'create_biolink_external_item_modal.subheader' => 'A more detailed link button to an external sold product.',
    ...
    'create_biolink_external_item_modal.name_color' => 'Name color',
    'create_biolink_external_item_modal.description_color' => 'Description color',
    'create_biolink_external_item_modal.price_color' => 'Price color',


    'create_biolink_share_modal.header' => 'Add a share button',
    'create_biolink_share_modal.subheader' => 'A button that opens a modal with all the easily sharable links to your page.',


    'create_biolink_youtube_feed_modal.header' => 'Add a YouTube feed',
    'create_biolink_youtube_feed_modal.subheader' => 'Display your latest youtube videos dynamically as button links on your page.',
    ...
    'create_biolink_timeline_modal.header' => 'Add a Timeline feed',
    'create_biolink_timeline_modal.subheader' => 'Display a simple, nice looking & customizable timeline widget on your page.',
    ...
    'create_biolink_review_modal.subheader' => 'Display a review that you received to build social proof on your page.',
    ...
    'create_biolink_image_slider_modal.subheader' => 'Display a horizontal collection of dynamically added images on your page.',
    ...
    'create_biolink_image_slider_modal.autoplay_interval' => 'Autoplay interval',
    ...
    'create_biolink_phone_collector_modal.subheader' => 'Capture phone numbers with ease from your visitors.',
    ...
    'create_biolink_phone_collector_modal.show_agreement' => 'Show agreement checkbox',
    ...
    'create_biolink_phone_collector_modal.phone_placeholder_default' => 'Your phone number',
    ...
    'create_biolink_contact_collector_modal.header' => 'Add a contact form',
    'create_biolink_contact_collector_modal.subheader' => 'Capture emails, phone numbers & messages from your visitors.',
    'create_biolink_contact_collector_modal.contact_collector_header' => 'Form settings',
    'create_biolink_contact_collector_modal.email_placeholder' => 'Email placeholder',
    'create_biolink_contact_collector_modal.phone_placeholder' => 'Phone placeholder',
    'create_biolink_contact_collector_modal.name_placeholder' => 'Name placeholder',
    'create_biolink_contact_collector_modal.message_placeholder' => 'Message placeholder',
    'create_biolink_contact_collector_modal.button_text' => 'Button text',
    'create_biolink_contact_collector_modal.success_text' => 'Thank you message',
    'create_biolink_contact_collector_modal.show_agreement' => 'Show agreement checkbox',
    'create_biolink_contact_collector_modal.show_agreement_help' => 'Require the user to confirm his agreement by ticking a checkbox.',
    'create_biolink_contact_collector_modal.agreement_url' => 'Agreement URL',
    'create_biolink_contact_collector_modal.agreement_text' => 'Agreement text',
    'create_biolink_contact_collector_modal.thank_you_url' => 'Thank you URL',
    'create_biolink_contact_collector_modal.thank_you_url_help' => 'Redirect the user to a specific URL after submitting the form. Leave empty to disable.',
    'create_biolink_contact_collector_modal.phone_placeholder_default' => '+401234567890',
    'create_biolink_contact_collector_modal.name_placeholder_default' => 'Your full name',
    'create_biolink_contact_collector_modal.email_placeholder_default' => 'Your valid email address',
    'create_biolink_contact_collector_modal.message_placeholder_default' => 'Your message to us',
    'create_biolink_contact_collector_modal.button_text_default' => 'Send message',
    'create_biolink_contact_collector_modal.success_text_default' => 'We got your message, we\'ll get back to you.',

    'create_biolink_donation_modal.header' => 'Get donations',
    'create_biolink_donation_modal.subheader' => 'Receive donations from your visitors with ease.',
    ...
    'create_biolink_product_modal.header' => 'Sell a digital product',
    'create_biolink_product_modal.subheader' => 'Sell digital products to your visitors with ease.',
    ...
    'create_biolink_service_modal.header' => 'Sell a service',
    'create_biolink_service_modal.subheader' => 'Sell services to your visitors with ease.',
    ...
    'create_biolink_block_modal.data_help' => 'All collected data can also be found in the Data page.',
    ...
    'create_biolink_map_modal.header' => 'Add a Google map',
    ...
    'create_biolink_map_modal.markers' => 'Markers addresses',
    'create_biolink_map_modal.markers_help' => 'One map marker address per line.',
    ...
    'create_biolink_typeform_modal.header' => 'Add a Typeform block',
    'create_biolink_typeform_modal.subheader' => 'Display a Typeform form widget on your page.',
    ...
    'create_biolink_rumble_modal.header' => 'Add a Rumble video',
    'create_biolink_rumble_modal.subheader' => 'Display a Rumble post widget on your page with ease.',
    'create_biolink_rumble_modal.location_url' => 'Rumble Video Embed URL',
    'create_biolink_rumble_modal.location_url_placeholder' => 'https://rumble.com/embed/v4oja79',


    'create_biolink_telegram_modal.header' => 'Add a Telegram post',
    'create_biolink_telegram_modal.subheader' => 'Display a Telegram post widget from a public channel on your bio page with ease.',
    'create_biolink_telegram_modal.location_url' => 'Telegram Post URL',
    'create_biolink_telegram_modal.location_url_placeholder' => 'https://t.me/altumcode/12345',


    'create_biolink_iframe_modal.header' => 'Add an iframe embed',
    'create_biolink_iframe_modal.subheader' => 'Display a website link within an iframe.',


    'biolink_link_create_modal.header' => 'Add a new block',
    'biolink_link_create_modal.category.standard' => 'Standard',
    'biolink_link_create_modal.category.standard_subheader' => 'The base blocks to help you with your general needs.',
    'biolink_link_create_modal.category.advanced' => 'Advanced',
    'biolink_link_create_modal.category.advanced_subheader' => 'The blocks which help you achieve more complex functionality.',
    'biolink_link_create_modal.category.embeds' => 'Embeds',
    'biolink_link_create_modal.category.embeds_subheader' => 'The blocks that help you integrate content from other websites.',
    'biolink_link_create_modal.category.payments' => 'Payments',
    'biolink_link_create_modal.category.payments_subheader' => 'The blocks that help you get paid & make money.',
    ...
    'tools.md5_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.md2_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.md4_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.whirlpool_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha1_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha224_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha256_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha384_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha512_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha512_224_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha512_256_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha3_224_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha3_256_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha3_384_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sha3_512_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.base64_encoder.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.base64_decoder.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.base64_to_image.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.image_to_base64.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.url_encoder.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.url_decoder.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.lorem_ipsum_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.markdown_to_html.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.case_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.random_number_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.uuid_v4_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.bcrypt_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.password_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.password_strength_checker.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.slug_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.html_minifier.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.css_minifier.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.js_minifier.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.user_agent_parser.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.file_mime_type_checker.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.gravatar_checker.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.character_counter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.list_randomizer.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.reverse_words.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.reverse_letters.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.emojis_remover.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.reverse_list.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.list_alphabetizer.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.upside_down_text_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.old_english_text_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.cursive_text_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.palindrome_checker.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.url_parser.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.color_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.duplicate_lines_remover.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.text_to_speech.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.idn_punnycode_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.json_validator_beautifier.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.qr_code_reader.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.barcode_reader.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.exif_reader.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.color_picker.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.sql_beautifier.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.html_entity_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.binary_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.hex_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.ascii_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.decimal_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.octal_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.morse_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.number_to_words_converter.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.mailto_link_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.youtube_thumbnail_downloader.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.safe_url_checker.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.utm_link_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.whatsapp_link_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.youtube_timestamp_link_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.image_optimizer.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.png_to_jpg.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.png_to_webp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.png_to_bmp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.png_to_gif.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.png_to_ico.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.jpg_to_png.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.jpg_to_webp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.jpg_to_bmp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.jpg_to_gif.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.jpg_to_ico.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.webp_to_png.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.webp_to_jpg.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.webp_to_ico.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.webp_to_bmp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.webp_to_gif.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.bmp_to_png.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.bmp_to_jpg.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.bmp_to_ico.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.bmp_to_webp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.bmp_to_gif.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.ico_to_png.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.ico_to_jpg.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.ico_to_bmp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.ico_to_webp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.ico_to_gif.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.gif_to_png.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.gif_to_jpg.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.gif_to_bmp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.gif_to_webp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.gif_to_ico.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.text_separator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.email_extractor.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.url_extractor.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.text_size_calculator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.paypal_link_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.bbcode_to_html.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.html_tags_remover.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.unix_timestamp_to_date.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.date_to_unix_timestamp.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
    ...
    'tools.signature_generator.extra_content' => 'Additional page content: Editable from the admin panel -> languages -> choose or create language -> translate app page.',
