...
return [
    ...
    'admin_blog.main.image_description' => 'Image description',
    ...
    'admin_plans.plan.splash_pages_limit' => 'Splash Pages Limit',
    ...
    'admin_plans.plan.static_limit' => 'Static sites Limit',
    'admin_plans.plan.static_limit_help' => 'The total amount of static sites that a user can create. Set -1 for unlimited.',
    ...
    'admin_plans.plan.track_links_retention' => 'Links statistics retention',
    'admin_plans.plan.track_links_retention_help' => 'How many days will the links statistics be kept in the database.',
    'admin_plans.plan.biolinks_templates' => 'Biolinks templates',
    ...
    'admin_plans.plan.force_splash_page_on_biolink' => 'Force splash page on bio links',
    'admin_plans.plan.force_splash_page_on_biolink_help' => 'Enabling this will force all the bio links of the user to have a temporary splash page with a countdown timer and ads (if you setup the ads). Only works if the splash pages limit is set to 0.',
    ...
    'admin_plans.plan.force_splash_page_on_vcard' => 'Force splash page on vcard links',
    'admin_plans.plan.force_splash_page_on_vcard_help' => 'Enabling this will force all the vcard links of the user to have a temporary splash page with a countdown timer and ads (if you setup the ads). Only works if the splash pages limit is set to 0.',
    ...
    'admin_plans.plan.utm_help' => 'Gives the user the ability to use the UTM parameters builder for links.',
    ...
    'admin_plans.plan.custom_css_is_enabled_help' => 'Enable ability to add custom css for resources that have this field. Be aware to only allow trusted people to use this feature.',
    'admin_plans.plan.custom_js_is_enabled' => 'Custom JS',
    'admin_plans.plan.custom_js_is_enabled_help' => 'Enable ability to add custom js for resources that have this field. Be aware to only allow trusted people to use this feature.',
    ...
    'admin_plans.plan.signatures_limit' => 'Signatures limit',
    'admin_plans.plan.exclusive_personal_api_keys' => 'Exclusive usage with personal API keys',
    'admin_plans.plan.exclusive_personal_api_keys_help' => 'The user will be required to add his own API keys to use the AI features.',
    'admin_plans.plan.documents_model' => 'AI Documents model',
    'admin_plans.plan.documents_model_help' => 'Select the AI model the user has access to when generating AI documents. You can read more details about the models on <a href="https://platform.openai.com/docs/models/" target="_blank">OpenAI Models</a> page.',
    'admin_plans.plan.documents_per_month_limit' => 'AI Documents limit',
    'admin_plans.plan.words_per_month_limit' => 'AI Words',
    'admin_plans.plan.images_per_month_limit' => 'AI Images',
    'admin_plans.plan.images_api' => 'AI Images API',
    'admin_plans.plan.images_api_help' => 'Select the AI API provider the user has access to when generating AI images.',
    'admin_plans.plan.chats_per_month_limit' => 'AI Chats',
    'admin_plans.plan.chat_messages_per_chat_limit' => 'AI Chat messages per chat window',
    'admin_plans.plan.chat_image_size_limit' => 'AI Chat image size limit',
    'admin_plans.plan.chats_model' => 'AI Chats model',
    'admin_plans.plan.chats_model_help' => 'Select the AI model the user has access to when using the AI chats functionality. You can read more details about the models on <a href="https://platform.openai.com/docs/models/" target="_blank">OpenAI Models</a> page.',
    'admin_plans.plan.transcriptions_per_month_limit' => 'AI Transcriptions',
    'admin_plans.plan.transcriptions_file_size_limit' => 'AI Transcriptions file size limit',
    'admin_plans.plan.transcriptions_file_size_limit_help' => 'Maximum 25MB - limited by the OpenAI API. You are not able to set a higher limit than your actual server upload limit.',
    'admin_plans.plan.syntheses_api' => 'AI Syntheses API',
    'admin_plans.plan.syntheses_api_help' => 'Select the AI API provider the user has access to when generating AI text to speech.',
    'admin_plans.plan.syntheses_per_month_limit' => 'AI Syntheses',
    'admin_plans.plan.synthesized_characters_per_month_limit' => 'AI Synthesized characters',
    ...
    'admin_codes.main.plans_ids' => 'Plans',
    ...
    'admin_tax_create.subheader' => 'Once a tax is created it can\'t be edited. After the tax is created, you can associate it with your created Plans.',
    ...
    'admin_index.support.inactive' => '<strong>Your future support inquiries will be discarded.</strong>You can %sExtend your support%s if you wish to be eligible for support again.',
   ...
   'admin_settings.facebook.tab' => 'Facebook login',
    ...
    'admin_settings.custom.head_js_biolink' => 'Biolink page custom JS',
    'admin_settings.custom.head_css_biolink' => 'Biolink page custom CSS',
    'admin_settings.custom.body_content_biolink' => 'Biolink page body content',
    'admin_settings.custom.head_js_splash_page' => 'Splash page custom JS',
    'admin_settings.custom.head_css_splash_page' => 'Splash page custom CSS',
    'admin_settings.custom.body_content_splash_page' => 'Splash page body content',
    ...
    'admin_settings.sso.is_enabled_help' => 'This feature allows you to connect other installations of Zyrex software and allow your users to easily switch between them with a single click of a button.',
    ...
    'admin_settings.sso.url_help' => 'The base URL of the another Zyrex software installation.',
    ...
    'admin_settings.ads.header_splash' => 'Splash page header',
    ...
    'admin_settings.links.biolinks' => 'Biolinks system',
    ...
    'admin_settings.links.others' => 'Others',
    'admin_settings.links.pixels' => 'Pixels system',
    ...
    'admin_settings.links.example_url' => 'Example biolink page URL',
    'admin_settings.links.example_url_help' => 'Display example biolink page button on the homepage. Leave empty to disable.',
    ...
    'admin_settings.links.biolinks_templates_is_enabled' => 'Enable the biolinks templates system',
    'admin_settings.links.biolinks_templates_is_enabled_help' => 'Enabling the biolinks templates system will give your users the ability to choose from a predefined (by you) biolink page templates.',
    'admin_settings.links.biolinks_themes_is_enabled' => 'Enable the biolinks themes system',
    'admin_settings.links.biolinks_themes_is_enabled_help' => 'Enabling the biolinks themes system will give your users the ability to choose from a predefined (by you) biolink page themes.',
    'admin_settings.links.biolinks_default_active_tab' => 'Biolinks default active tab',
    'admin_settings.links.default_biolink_theme_id' => 'Biolinks default theme',
    'admin_settings.links.default_biolink_theme_id_help' => 'Set this if you want your biolink pages to start with a specific theme that you created via the admin panel.',
    'admin_settings.links.default_biolink_theme_id_help2' => 'This feature only works if there are no templates used for starting a new biolink page.',
    'admin_settings.links.default_biolink_template_id' => 'Biolinks default template',
    'admin_settings.links.default_biolink_template_id_help' => 'Set this if you want your biolink pages to start with a specific template that you created via the admin panel.',
    'admin_settings.links.biolinks_new_blocks_position' => 'Biolinks new blocks position',
    'admin_settings.links.biolinks_new_blocks_position.top' => 'Top',
    'admin_settings.links.biolinks_new_blocks_position.bottom' => 'Bottom',
    'admin_settings.links.splash_page_is_enabled' => 'Enable the Splash Page system',
    'admin_settings.links.splash_page_is_enabled_help' => 'Enabling the Splash Page will give you and your users the ability to have temporary pages with a countdown timer before accessing custom links.',
    'admin_settings.links.splash_page_auto_redirect' => 'Splash page auto redirect',
    'admin_settings.links.splash_page_auto_redirect_help' => 'Enabling this will auto redirect the user once the splash page countdown timer finishes.',
    'admin_settings.links.splash_page_link_unlock_seconds' => 'Splash page countdown timer',
    ...
    'admin_settings.links.static_is_enabled' => 'Enable the static sites system',
    'admin_settings.links.static_is_enabled_help' => 'Enabling this will give your users the ability to create static html type links (Offload plugin not supported).',
    ...
    'admin_settings.links.directory_access' => 'Who gets access',
    'admin_settings.links.directory_access_everyone' => 'Guests & users',
    'admin_settings.links.directory_access_users' => 'Users only',
    ...
    'admin_settings.links.avatar_size_limit' => 'Biolink avatar size limit',
    'admin_settings.links.background_size_limit' => 'Biolink background size limit',
    'admin_settings.links.favicon_size_limit' => 'Favicon size limit',
    'admin_settings.links.seo_image_size_limit' => 'OpenGraph image size limit',
    'admin_settings.links.thumbnail_image_size_limit' => 'Biolink block thumbnail size limit',
    'admin_settings.links.image_size_limit' => 'Biolink other images size limit',
    'admin_settings.links.audio_size_limit' => 'Biolink audio file size limit',
    'admin_settings.links.video_size_limit' => 'Biolink video file size limit',
    'admin_settings.links.file_size_limit' => 'Biolink file block size limit',
    ...
    'admin_settings.links.google_static_maps_is_enabled_help' => 'The integration will enable the Maps Block to be used on biolink pages.',
    'admin_settings.links.google_static_maps_api_key' => 'Google Static Maps API Key',
    'admin_settings.links.available_biolink_blocks' => 'Available blocks',
    ...
    'admin_settings.signatures.tab' => 'Signatures',
    'admin_settings.signatures.is_enabled' => 'Enable signatures system',
    'admin_settings.signatures.branding' => 'Branding',
    'admin_settings.signatures.branding_help' => 'This branding is used by default in the signatures. HTML can be used in this field.',

    'admin_settings.aix.tab' => 'AIX',
    'admin_settings.aix.openai_api_key' => 'OpenAI - API Key',
    'admin_settings.aix.openai_api_key_help' => 'You can also insert multiple OpenAI API Keys per line and the system will randomly choose one on each request.',
    'admin_settings.aix.clipdrop_api_key' => 'ClipDrop - API Key',
    'admin_settings.aix.clipdrop_api_key_help' => 'You can also insert multiple ClipDrop API Keys per line and the system will randomly choose one on each request.',
    'admin_settings.aix.documents_is_enabled' => 'Enable the AI Documents system',
    'admin_settings.aix.images_is_enabled' => 'Enable the AI Images system',
    'admin_settings.aix.transcriptions_is_enabled' => 'Enable the AI Speech to Text system',
    'admin_settings.aix.chats_is_enabled' => 'Enable the AI Chatting system',
    'admin_settings.aix.chats_assistant_name' => 'Demo Assistant name (shown in the landing page)',
    'admin_settings.aix.chats_avatar' => 'Demo assistant avatar (shown in the landing page)',
    'admin_settings.aix.images_display_latest_on_index' => 'Display latest generated AI images on the homepage',
    'admin_settings.aix.input_moderation_is_enabled' => 'Input NSFW moderation',
    'admin_settings.aix.input_moderation_is_enabled_help' => 'This will make it so that the user input will be first validated with OpenAI servers, so that it does not contain violence, hate, self-harm and NSFW inputs. Highly recommended to enable this, so that you avoid getting your OpenAI account banned if your users try to abuse it.',
    'admin_settings.aix.available_types' => 'Available types',
    'admin_settings.aix.documents_available_languages' => 'Available languages',
    'admin_settings.aix.documents_available_languages_help' => 'Names of the languages you want to allow, comma separated values.',
    'admin_settings.aix.images_available_artists' => 'Available artists',
    'admin_settings.aix.images_available_artists_help' => 'Generate AI images with the style of one of these artists. Write in names of highly popular artists, comma separated values, leave empty to disable. Test those inputs before going to production with them.',
    'admin_settings.aix.syntheses_is_enabled' => 'Enable the AI Text to Speech system',
    ...
    'admin_languages.info_message.max_input_vars' => 'Your server\'s PHP settings (max_input_vars) allow you to submit %1$s translated fields at one time.',
    'admin_languages.info_message.total' => 'There are currently %1$s/%2$s filled translation strings (%3$s empty translation strings).',
    'admin_languages.info_message.main' => 'The main language will always be replaced with releases of new updates.',
    ...
    'admin_statistics.signatures.chart' => 'New signatures',

    'admin_statistics.documents.menu' => 'AI Documents',
    'admin_statistics.documents.header' => 'AI Documents',
    'admin_statistics.documents.chart' => 'New AI documents',

    'admin_statistics.images.menu' => 'AI Images',
    'admin_statistics.images.header' => 'AI Images',
    'admin_statistics.images.chart' => 'New AI images',

    'admin_statistics.transcriptions.menu' => 'AI Transcriptions',
    'admin_statistics.transcriptions.header' => 'AI Transcriptions',
    'admin_statistics.transcriptions.chart' => 'New AI Transcriptions',

    'admin_statistics.syntheses.menu' => 'AI Syntheses',
    'admin_statistics.syntheses.header' => 'AI Syntheses',
    'admin_statistics.syntheses.chart' => 'New AI Syntheses',

    'admin_statistics.chats.menu' => 'AI Chats',
    'admin_statistics.chats.header' => 'AI Chats',
    'admin_statistics.chats.chart' => 'New AI Chats',

    'admin_statistics.chats_messages.menu' => 'AI Chats messages',
    'admin_statistics.chats_messages.header' => 'AI Chats messages',
    'admin_statistics.chats_messages.chart' => 'New AI Chats messages',
    ...
    'admin_broadcasts.main.cities_placeholder' => 'Tokyo, New York, Istanbul',
    'admin_broadcasts.main.cities_help' => 'Comma separated values.',
    'admin_broadcasts.main.browser_languages' => 'Browser languages',
    'admin_broadcasts.main.languages' => 'Languages',
    'admin_broadcasts.main.operating_systems' => 'Operating systems',
    'admin_broadcasts.main.browsers' => 'Browsers',
    ...
    'admin_biolinks_blocks.title' => 'Biolinks blocks',
    'admin_biolinks_blocks.header' => 'Biolinks blocks',
    'admin_biolinks_blocks.menu' => 'Bio. blocks',


    'admin_biolinks_themes.breadcrumb' => 'Biolinks themes',
    'admin_biolinks_themes.title' => 'Biolinks themes',
    'admin_biolinks_themes.header' => 'Biolinks themes',
    ...
    'admin_biolinks_themes.total_usage' => 'Total usage',
    ...
    'admin_biolink_theme_create.menu' => 'Create theme',
    ...
    'admin_biolinks_templates.breadcrumb' => 'Biolinks templates',
    'admin_biolinks_templates.title' => 'Biolinks templates',
    'admin_biolinks_templates.header' => 'Biolinks templates',
    'admin_biolinks_templates.menu' => 'Bio. templates',
    'admin_biolinks_templates.main.total_usage' => 'Total usage',
    'admin_biolinks_templates.main.link_id' => 'Biolink page',
    'admin_biolinks_templates.main.link_id_help' => 'Select the biolink page that will be used as a template & preview. Only biolink pages by admin users will show up here. Once you choose a biolink page, do not edit the URL of it.',
    'admin_biolinks_templates.error_message.link_id' => 'Biolink ID is not valid.',


    'admin_biolink_template_create.breadcrumb' => 'Create biolink template',
    'admin_biolink_template_create.title' => 'Create biolink template',
    'admin_biolink_template_create.header' => 'Create biolink template',
    'admin_biolink_template_create.menu' => 'Create template',


    'admin_biolink_template_update.breadcrumb' => 'Edit biolink template',
    'admin_biolink_template_update.title' => 'Edit biolink template',
    'admin_biolink_template_update.header' => 'Edit biolink template',
    ...
    'admin_signatures.title' => 'Signatures',
    'admin_signatures.header' => 'Signatures',
    'admin_signatures.menu' => 'Signatures',


    'admin_documents.title' => 'AI Documents',
    'admin_documents.header' => 'AI Documents',
    'admin_documents.menu' => 'AI Documents',


    'admin_images.title' => 'AI Images',
    'admin_images.header' => 'AI Images',
    'admin_images.menu' => 'AI Images',


    'admin_transcriptions.title' => 'AI Transcriptions',
    'admin_transcriptions.header' => 'AI Transcriptions',
    'admin_transcriptions.menu' => 'AI Transcriptions',


    'admin_chats.title' => 'AI Chats',
    'admin_chats.header' => 'AI Chats',
    'admin_chats.menu' => 'AI Chats',
    'admin_chats.chats_current_month' => 'Chats this month',


    'admin_templates_categories.breadcrumb' => 'AI Templates Categories',
    'admin_templates_categories.title' => 'AI Templates Categories',
    'admin_templates_categories.menu' => 'AI Templates Categories',
    'admin_templates_categories.header' => 'AI Templates Categories',
    'admin_templates_categories.create' => 'Create template category',
    'admin_templates_categories.table.design' => 'Icon & emoji',
    'admin_templates_categories.main.template_category_id' => 'Template category',
    'admin_templates_categories.main.emoji' => 'Emoji',
    'admin_templates_categories.main.emoji_placeholder' => '⭐️',
    'admin_templates_categories.main.color' => 'Text color',
    'admin_templates_categories.main.background' => 'Background color',


    'admin_template_category_create.breadcrumb' => 'Create template category',
    'admin_template_category_create.title' => 'Create template category',
    'admin_template_category_create.menu' => 'Create template category',
    'admin_template_category_create.header' => 'Create a new template category',


    'admin_template_category_update.breadcrumb' => 'Edit template category',
    'admin_template_category_update.title' => 'Edit template category',
    'admin_template_category_update.header' => 'Edit template category',


    'admin_templates.breadcrumb' => 'AI Templates',
    'admin_templates.title' => 'AI Templates',
    'admin_templates.menu' => 'AI Templates',
    'admin_templates.header' => 'AI Templates',
    'admin_templates.create' => 'Create template',
    'admin_templates.table.template' => 'Template',
    'admin_templates.main.inputs' => 'Inputs',
    'admin_templates.main.input.key' => 'Input key',
    'admin_templates.main.input.key_placeholder' => 'text',
    'admin_templates.main.input.type' => 'Input type',
    'admin_templates.main.input.placeholder' => 'Placeholder',
    'admin_templates.main.input.help' => 'Help info',
    'admin_templates.main.total_usage' => 'Total usage',
    'admin_templates.main.prompt' => 'Prompt',
    'admin_templates.main.prompt_placeholder' => 'Explain the following text as if you were a 1st grader: {text}',
    'admin_templates.main.prompt_help' => 'This is the prompt that will get sent to OpenAI API. You can use <code>{key}</code> variables based on the key value of your dynamic inputs. Be mindful of how long the prompt is, as it uses tokens on OpenAI and the result length may be shorter if you have a long prompt',


    'admin_template_create.breadcrumb' => 'Create template',
    'admin_template_create.title' => 'Create template',
    'admin_template_create.menu' => 'Create template',
    'admin_template_create.header' => 'Create a new template',


    'admin_template_update.breadcrumb' => 'Edit template',
    'admin_template_update.title' => 'Edit template',
    'admin_template_update.header' => 'Edit template',


    'admin_syntheses.title' => 'AI Syntheses',
    'admin_syntheses.header' => 'AI Syntheses',
    'admin_syntheses.menu' => 'AI Syntheses',


    'admin_chats_assistants.breadcrumb' => 'AI Assistants',
    'admin_chats_assistants.title' => 'AI Assistants',
    'admin_chats_assistants.menu' => 'AI Assistants',
    'admin_chats_assistants.header' => 'AI Assistants',
    'admin_chats_assistants.create' => 'Create assistant',
    'admin_chats_assistants.table.chat_assistant' => 'Chat assistant',
    'admin_chats_assistants.main.total_usage' => 'Total usage',
    'admin_chats_assistants.main.prompt' => 'Prompt',
    'admin_chats_assistants.main.prompt_placeholder' => 'Act like Bill Gates.',
    'admin_chats_assistants.main.prompt_help' => 'This is the prompt that will get sent to OpenAI API to tell the AI what type of personality to use. Be mindful of how long the prompt is, as it uses tokens on OpenAI and the result length may be shorter if you have a long prompt',
    'admin_chats_assistants.main.image' => 'Avatar',


    'admin_chat_assistant_create.breadcrumb' => 'Create chat assistant',
    'admin_chat_assistant_create.title' => 'Create chat assistant',
    'admin_chat_assistant_create.menu' => 'Create chat assistant',
    'admin_chat_assistant_create.header' => 'Create a new chat assistant',
