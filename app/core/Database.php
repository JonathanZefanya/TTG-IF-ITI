...
class Database {
    ...
    public static function initialize() {
        ...
        if(self::$database->connect_error) {
            ...
            echo '<div>';
            //echo '<a href="https://zyrex.win/" target="_blank"><img src="https://zyrex.win/themes/altum/assets/images/altumcode.svg" class="altumcode-logo" alt="altumcode logo" loading="lazy" /></a>';
            ...
            //echo '<p class="buttons"><smalsl><a href="' . PRODUCT_DOCUMENTATION_URL .'" target="_blank">📜 Read documentation</a> &nbsp;&bullet;&nbsp; <a href="https://zyrex.win/contact" target="_blank">📧 Contact support</a></smalsl></p>';
            echo '</div>';
            die();
        }
