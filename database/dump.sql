...
(NULL, 'https://github.com/JonathanZefanya', 'Software by Jonathan Zefanya', '', '', 'external', 'bottom', 1, 0, NOW(), NOW()),
(NULL, 'https://if.iti.ac.id', 'Made in IF ITI', '', '', 'external', 'bottom', 0, 0, NOW(), NOW());
...
('payment', '{"is_enabled":false,"type":"both","default_payment_frequency":"monthly","currencies":{"IDR":{"code":"IDR","symbol":"Rp.","default_payment_processor":"offline_payment"}},"default_currency":"IDR","codes_is_enabled":true,"taxes_and_billing_is_enabled":true,"invoice_is_enabled":true,"user_plan_expiry_reminder":0,"user_plan_expiry_checker_is_enabled":0,"currency_exchange_api_key":""}'),
...
('coinbase', '{"is_enabled":false,"api_key":"","webhook_secret":"","currencies":["IDR"]}'),
('payu', '{"is_enabled":false,"mode":"sandbox","merchant_pos_id":"","signature_key":"","oauth_client_id":"","oauth_client_secret":"","currencies":["IDR"]}'),
('iyzico', '{"is_enabled":false,"mode":"live","api_key":"","secret_key":"","currencies":["IDR"]}'),
('paystack', '{"is_enabled":false,"public_key":"","secret_key":"","currencies":["IDR"]}'),
('razorpay', '{"is_enabled":false,"key_id":"","key_secret":"","webhook_secret":"","currencies":["IDR"]}'),
...
('paddle', '{"is_enabled":false,"mode":"sandbox","vendor_id":"","api_key":"","public_key":"","currencies":["IDR"]}'),
('mercadopago', '{"is_enabled":false,"access_token":"","currencies":["IDR"]}'),
('midtrans', '{"is_enabled":false,"server_key":"","mode":"sandbox","currencies":["IDR"]}'),
('flutterwave', '{"is_enabled":false,"secret_key":"","currencies":["IDR"]}'),
('smtp', '{"from_name":"","from":"","reply_to_name":"","reply_to":"","cc":"","bcc":"","host":"","encryption":"tls","port":"","auth":0,"username":"","password":"","display_socials":false,"company_details":""}'),
...
('product_info', '{\"version\":\"1.0.0\", \"code\":\"5100\"}');
...
CREATE TABLE `links` (
  ...
  `datetime` datetime NOT NULL,
  PRIMARY KEY (`link_id`),
  UNIQUE KEY `unique_project_id` (`project_id`), -- Tambahkan UNIQUE KEY di project_id
  KEY `user_id` (`user_id`),
  KEY `url` (`url`),
